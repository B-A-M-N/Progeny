...
- Parent can enable a same-child warm-up sequence (3 independent short runs) to build comfort.
...
It also exposes a QR endpoint so tablets can join by scan instead of typing.
